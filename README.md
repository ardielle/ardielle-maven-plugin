...
The `:generate-resources` goal generates jax-rs resources from a project's rdl files.

```
mvn rdl:generate-resources
```
...
Code generated by the `:generate-resources` goal will depend on [rdl-java](https://github.com/ardielle/ardielle-java)
